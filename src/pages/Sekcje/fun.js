                            ...
                            <div className="a box">
                                ...
                                <ol>
                                    <li>
                                        ...
                                        <p>
                                            <strong>Nasze święto jest totalnie wyluzowane i dalekie od oficjalnej spiny.
                                                Chcemy odwoływać się do zupełnie naturalnego poczucia dumy i chęci okazania
                                                swojego przywiązania do naszego kraju.</strong>
                                            <br></br>
                                            <u>
                                                Przy czym warto podkreślać, iż można to czynić w sposób radosny, otwarty, wolny
                                                od agresji, bazujący na naszych wspaniałych cechach; poczuciu humoru i
                                                słowiańskiej skłonności do uciech i zabaw.</u>
                                        </p>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div className="d box">
                                ...
                                <ol>
                                    <li>
                                        <span></span>
                                        <p>
                                            <strong>Chcemy pokazać, że ludzie pogodni, wyluzowani mogą być najzwyczajniej w
                                                świecie dumni z tego, że pochodzą z Kraju nad Wisłą</strong>,
                                            a imprezowanie może być jedną z narodowych cnót sprzyjających integracji i
                                            budowaniu wspólnoty.
                                        </p>
                                    </li>
                                </ol>
                            ...
                            <div className="e box">
                                ...
                                <ol>
                                    <li>
                                        <span></span>
                                        <p>
                                            <strong>Pragniemy aby Święto Niepodległości kojarzyło się z dumą, aby patriotyzm
                                                nabrał nowego znaczenia</strong>, a młodzi Polacy chcieli świętować to, że żyją w wolnej, nowoczesnej Ojczyźnie</p>
                                    </li>
                                </ol>
                            </div>
                            <div className="f box">
                                ...
                                <ol>
                                    <li>
                                        <span></span>
                                        <p>Skłonność do zabaw jest jedną z naszych najfajniejszych cech narodowych,
                                            którą warto celebrować, pielęgnować i szukać sposobności dla jej utrwalenia
                                        </p>
                                    </li>
                                </ol>
                            </div>
