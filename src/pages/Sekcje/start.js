...
const Start = (props) => {
    ...
    const style = (props.isVisible
        ? 'hero is-fullheight asfaltbackground visible'
        : 'hero is-fullheight asfaltbackground start notVisable');
            ...
            <div className="hero-body">
                ...
                <div className="container has-text-centered intro">
                    ...
                    <div className="fbicon">
                        <a href="https://facebook.com/nocniepodleglosci/" target="_blanc"><img src={facebook} alt="noc niepodległości"/>/nocniepodleglosci/</a>
                    </div>
                    <div className="Noc">
